        ...
        <View style={[styles.leftCol, { flex: 1 }]}>
          <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            ...
            <Button
              ...
              icon={<MaterialIcons name="edit" size={18} color={colors.purple} />}
              style={{ width: "100%", marginBottom: 12 }}
            />
            <Button
              title="My Dashboard"
              variant="outline"
              onPress={() => router.push("/freelancer-dashboard")}
              icon={<MaterialIcons name="dashboard" size={18} color={colors.purple} />}
              style={{ width: "100%", marginBottom: 12 }}
            />
            {user?.role === "admin" && (
              <Button
                ...
                icon={<MaterialIcons name="admin-panel-settings" size={18} color={colors.purple} />}
                style={{ width: "100%", marginBottom: 12 }}
              />
            )}
          </View>
...
export default function ProfileScreen() {
  ...
  if (user?.role === "employer") {
    return <EmployerProfileBody user={user} colors={colors} isDark={isDark} router={router} />;
  }
  return <FreelancerProfileBody user={user} colors={colors} isDark={isDark} router={router} />;
}
